...
void stickwomen_chat(int speed,int box_color,int text_color)
{
   ...
   setcolor(text_color);
    settextstyle(EUROPEAN_FONT,HORIZ_DIR,1);
	outtextxy(45+s,210,"Phopo n raat ko sota hua ring phna di");
	outtextxy(100+s,240,"Abba nhi maan rha");
...
void end()
{
	...
	outtextxy(50,150,"like the story");
	settextstyle(EUROPEAN_FONT,HORIZ_DIR,4);
	setcolor(LIGHTBLUE);
	outtextxy(100,230,"Phochna na main n bhi google sa bnaya h yh");
}
// driver program
int main()
{
